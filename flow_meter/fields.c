...
short ur_field_sizes_static[] = {
   ...
   4, /* ODID */
   4, /* PACKETS */
   4, /* SMTP_2XX_STAT_CODE_COUNT */
   4, /* SMTP_3XX_STAT_CODE_COUNT */
   4, /* SMTP_4XX_STAT_CODE_COUNT */
   4, /* SMTP_5XX_STAT_CODE_COUNT */
   4, /* SMTP_COMMAND_FLAGS */
   4, /* SMTP_MAIL_CMD_COUNT */
   4, /* SMTP_RCPT_CMD_COUNT */
   4, /* SMTP_STAT_CODE_FLAGS */
   2, /* ARP_HA_FORMAT */
   2, /* ARP_OPCODE */
   2, /* ARP_PA_FORMAT */
   2, /* DNS_ANSWERS */
...
ur_field_type_t ur_field_types_static[] = {
   ...
   UR_TYPE_UINT32, /* SMTP_2XX_STAT_CODE_COUNT */
   UR_TYPE_UINT32, /* SMTP_3XX_STAT_CODE_COUNT */
   UR_TYPE_UINT32, /* SMTP_4XX_STAT_CODE_COUNT */
   UR_TYPE_UINT32, /* SMTP_5XX_STAT_CODE_COUNT */
   UR_TYPE_UINT32, /* SMTP_COMMAND_FLAGS */
   UR_TYPE_UINT32, /* SMTP_MAIL_CMD_COUNT */
   UR_TYPE_UINT32, /* SMTP_RCPT_CMD_COUNT */
   UR_TYPE_UINT32, /* SMTP_STAT_CODE_FLAGS */
   UR_TYPE_UINT16, /* ARP_HA_FORMAT */
   UR_TYPE_UINT16, /* ARP_OPCODE */
   UR_TYPE_UINT16, /* ARP_PA_FORMAT */
   UR_TYPE_UINT16, /* DNS_ANSWERS */
   UR_TYPE_UINT16, /* DNS_ATYPE */
   ...
   UR_TYPE_STRING, /* SMTP_DOMAIN */
   UR_TYPE_STRING, /* SMTP_FIRST_RECIPIENT */
   UR_TYPE_STRING, /* SMTP_FIRST_SENDER */
};
ur_static_field_specs_t UR_FIELD_SPECS_STATIC = {ur_field_names_static, ur_field_sizes_static, ur_field_types_static, 80};
ur_field_specs_t ur_field_specs = {ur_field_names_static, ur_field_sizes_static, ur_field_types_static, 80, 80, 80, NULL, UR_UNINITIALIZED};
